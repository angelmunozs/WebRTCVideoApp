...
// Audio
var sendAudio = new Audio("audio/send.wav");
var receiveAudio = new Audio("audio/receive.wav");
...
//  Print messages in textarea
function printMessage(message, realm) {
  switch(realm) {
    case 'sent' :
...
function handleMessage(event) {
  ...
  printMessage(event.data, 'received')
}
